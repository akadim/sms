...
- On Windows Server WAMP / XAMPP  need to rewrite apache serveice : click on the WAMP/XAMPP icong and goto apache --> Apache Modules --> rewrite_modle  make sure this rewrite_module is chacked.
